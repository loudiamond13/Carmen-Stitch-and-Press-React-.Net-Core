...
{
    public class OrderImageRepository: GenericRepository<CSPSDbContext, OrderImage>, IOrderImageRepository
    {
        public OrderImageRepository(CSPSDbContext ctx): base(ctx)
        {
